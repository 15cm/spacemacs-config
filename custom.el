(custom-set-variables
 ...
 '(cnfonts-personal-fontnames
   '(("Monaco" "Iosevka Nerd Font Mono")
     ("Sarasa Mono SC" "Noto Sans Mono CJK SC" "Sarasa Mono SC Nerd Font")
     ("HanaMinB")
     nil nil))
